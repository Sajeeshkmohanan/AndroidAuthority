...
//            mAdapter.notifyItemChanged(mLocation);
        }
        updateSubtitle();
        checkEmpty();
    }
    ...
    private void updateSubtitle() {
        ...
        String subtitle;
        if (mSubtitleVisible) {
            int crime_count = lab.size();
            subtitle = getResources().getQuantityString(R.plurals.subtitle_plural, crime_count, crime_count + "");
        } else {
            subtitle = null;
        }
